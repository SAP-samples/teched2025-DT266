...
> [!IMPORTANT]    
> Prerequisite for this exercise is that you implement **the code snippet** in class **`ZCL_DT266_CARR_EXTENSION_###`** as outlined in section **Logon and Connect: Adapt the source code in class ZCL_DT266_CARR_EXTENSION_###** of [Getting Started 0.1: About the Session](../ex0/README.md#getting-started-02-overview-of-the-model-and-abap-code).
> **If you have not already implemented the code snippet in [Getting Started 0.1: About the Session](../ex0/README.md#getting-started-02-overview-of-the-model-and-abap-code) please perform this before continuing with the exercises.** 
<!--
