 ...
 <details>
  <summary>🔵 Click to expand!</summary>
   ...
   1. Call and execute the Fiori App:
      ...
      |---|---|
      | <img src="images/Navigate_to_Preview.png" alt="generate UI service" width="2000">| Navigate to `<SID>_EN` > `Favorite Packages` > `ZDT266_`**`###`**  <br> > `Business Services` > **`Service Bindings`**. <br> <br> Double-click on **`ZUI_DT266_CARR_###_O4`**.  |
