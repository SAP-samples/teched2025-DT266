...
> [!IMPORTANT]    
> Prerequisite for this exercise is that you implement **the code snippet** in class **`ZCL_DT266_CARR_EXTENSION_###`** as outlined in secion <br>
> **Logon and Connect: Adapt the source code in class ZCL_DT266_CARR_EXTENSION_###** of [Getting Started 0.1: About the Session - Adapt the source code in class ZCL_DT266_CARR_EXTENSION_###](../ex0/README.md#️-adapt-the-source-code-in-class-zcl_dt266_carr_extension_).
