...
> 
> 💡 **In case you have performed succesfully all the previous exercises you can directly continue with** [Exercise 3.1](../ex03/README.md#exercise-31-learn-about-the-abap-cross-trace-and-set-up-a-trace-configuration). <br> <br>
