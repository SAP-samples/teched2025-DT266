...
Here we have just the **End** (Hierarchy) <img src="images/CrossTrace_End.png" alt="Search for validate" width="1%"> for this validation. Now we want to see also the **Begin of the Hierarchy** <img src="images/CrossTrace_Begin_Validation.png" alt="Search for validate" width="10%">. The reason is that in the **Begin** the processed object (like draft tables, custom validations, etc. ) are shown:
