CLASS lhc_zr_dt266_carr_042 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    METHODS:
...
CLASS lhc_zr_dt266_carr_042 IMPLEMENTATION.
  ...
  METHOD validateAirLineName.
    ...
    READ ENTITIES OF zr_dt266_carr_042 IN LOCAL MODE
      ENTITY Carrier
