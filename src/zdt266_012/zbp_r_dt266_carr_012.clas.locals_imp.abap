CLASS lhc_zr_dt266_carr_012 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    METHODS:
...
CLASS lhc_zr_dt266_carr_012 IMPLEMENTATION.
  ...
  METHOD validateAirLineName.
    ...
    READ ENTITIES OF zr_dt266_carr_012 IN LOCAL MODE
      ENTITY Carrier
