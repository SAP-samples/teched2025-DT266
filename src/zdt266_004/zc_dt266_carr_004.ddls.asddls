...
@ObjectModel: {
  sapObjectNodeType.name: 'ZDT266_CARR_004'
}
@AccessControl.authorizationCheck: #MANDATORY
define root view entity ZC_DT266_CARR_004
  provider contract transactional_query
  as projection on ZR_DT266_CARR_004
  association [1..1] to ZR_DT266_CARR_004 as _BaseEntity on $projection.CarrierID = _BaseEntity.CarrierID
{
  @Consumption: {
    valueHelpDefinition: [ {
  ...
  @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_DT266_CARR_EXTENSION_004'
