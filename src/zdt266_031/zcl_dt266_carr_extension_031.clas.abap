CLASS zcl_dt266_carr_extension_031 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_DT266_CARR_EXTENSION_031 IMPLEMENTATION.
...
*    out->write( |[DT266] Run finished for ZCL_DT266_LOOP1_{ group_id }. | ).
  ...
  METHOD get_supplements_ABAP.
    SELECT supplement_id,id, supplement_category, price FROM zdt266_sup_i_031
  ...
  METHOD get_prices_ABAP.
    ...
    DATA:
      group_id              TYPE string VALUE '031',
      id                    TYPE int4,
      ls_id                 TYPE ty_id,
...
*      ENDIF.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    DATA lt_original_data TYPE STANDARD TABLE OF zc_dt266_carr_031 WITH DEFAULT KEY.
